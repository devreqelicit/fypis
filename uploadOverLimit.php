...
<div align="center"><br />
  <table width="1004" height="487" border="2" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
    <tr>
      <td width="998" height="483" bgcolor="#FFFFFF"><table width="998" height="480" border="0" cellpadding="0" cellspacing="0">
          <tr>
                    ...
                    <tr>
                      <td width="631" height="213"><table width="216" border="0" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <td width="28" height="18" class="style34"><div align="center"><img src="icons/pelajar_detail.png" width="24" height="23" /></div></td>
                        ...
                        <div align="center">
                            <table width="579" border="2" cellpadding="0" cellspacing="0" bordercolor="#990000">
                              <tr>
                                <td width="573" height="114"  bgcolor="#cc6666"><table width="394" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
                                    <tr>
                                      <form action="uploadSuccessfull.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <td width="438"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                            <tr>
                                              <td  bgcolor="#cc6666">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td  bgcolor="#cc6666"><span class="style26 style51"><strong>&nbsp;Muat Naik Fail (Had Saiz Fail  100 MB)</strong></span></td>
                                            </tr>
                                            <tr>
                                              <td  bgcolor="#cc6666">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td align="center"  bgcolor="#cc6666"><span class="style52">Pilih Fail :</span>
                                              <input name="uploadfail" type="file" id="uploadfail" size="35" /></td>
                                            </tr>
                                            <tr>
                                              <td  height="57" align="center"    bgcolor="#cc6666"><input type="submit" name="Submit" value="Muat Naik" /></td>
                                            </tr>
                                        </table></td>
                                      </form>
                                    </tr>
                          ...
                          <table width="344" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                              <td width="67"><div align="center"><img src="menu/error.gif" width="39" height="32" /></div></td>
