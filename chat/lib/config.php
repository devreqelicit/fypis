...
// Database name:
$config['dbConnection']['name'] = 'smppta';
// Database type:
...
$config['langNames'] = array(
	'ar'=>'????', 'bg'=>'?????????', 'ca'=>'Català', 'cy'=>'Cymraeg', 'cz'=>'Cesky', 'da'=>'Dansk', 'de'=>'Deutsch', 'el'=>'???????a', 'en'=>'English',
	'es'=>'Español', 'et'=>'Eesti', 'fa'=>'?????', 'fi'=>'Suomi', 'fr'=>'Français', 'gl'=>'Galego', 'he'=>'?????', 'hr' => 'Hrvatski', 'hu' => 'Magyar', 'in'=>'Bahasa Indonesia', 'it'=>'Italiano',
	'ja'=>'???','ka'=>'???????','kr'=>'? ?','mk'=>'??????????', 'nl'=>'Nederlands', 'no'=>'Norsk', 'pl'=> 'Polski', 'pt-br'=>'Português (Brasil)', 'pt-pt'=>'Português (Portugal)', 
	'ro'=>'România', 'ru'=>'???????', 'sk'=> 'Slovencina', 'sl'=>'Slovensko', 'sr'=>'Srpski', 'sv'=> 'Svenska', 'th'=>'&#x0e20;&#x0e32;&#x0e29;&#x0e32;&#x0e44;&#x0e17;&#x0e22;', 
