                      ...
                      <table width="200" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <div align="center">
                            <table width="579" border="2" cellpadding="0" cellspacing="0" bordercolor="#990000">
                              <tr>
                                <td width="573" height="114"  bgcolor="#FFCCCC"><table width="394" border="0" align="center" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
                                    <tr>
                                      <form action="uploadSuccessfull.php" method="post" enctype="multipart/form-data" name="form1" id="form1">
                                        <td width="438"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                            ...
                                            <tr>
                                              <td  bgcolor="#FFCCCC"><span class="style26 style51"><strong>&nbsp;<span class="style26">Muat Naik Fail (Had Saiz Fail  100 MB)</span></strong></span></td>
                                            </tr>
                                            <tr>
                                              <td  bgcolor="#FFCCCC">&nbsp;</td>
                                            </tr>
                                            <tr>
                                              <td align="center"  bgcolor="#FFCCCC"><span class="style52">Pilih Fail :</span>
                                                <span class="style53">
                                                <input name="uploadfail" type="file" id="uploadfail" size="35" />
                                              </span></td>
                                            </tr>
                                            <tr>
