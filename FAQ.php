                ...
                <table width="800" border="0" cellpadding="0" cellspacing="0" bor="bor"">
                  <tr>
                    <td width="731" bgcolor="#FFFFFF"><div align="center">
                      <table width="713" border="2" bordercolor="#990000" bgcolor="#FFCCFF" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="707" height="231"><div align="center"><br />
                              <div align="center">
...
?></td>
                                  ...
                                  <tr>
                                    <td width="27" height="22" bgcolor="#FFCCFF"><span class="style49"><span class="style49"><? echo $bil ?></span><span class="style26">.</span></span></td>
                                    <td width="652" bgcolor="#FFCCFF"><table width="62" border="0" cellpadding="0">
                                        <tr>
                                          <td width="58" bgcolor="#CC6666"><div align="center"><span class="style49"><span class="style35"><span class="style26">Soalan</span></span></span></div></td>
                                        </tr>
                                      </table></td>
                                  </tr>
                                  <tr>
                                    <td bgcolor="#FFCCFF">&nbsp;</td>
                                    <td height="35" bgcolor="#FFCCFF" class="style26"><? echo $row['faq']; ?></td>
                                  </tr>
                                  <tr>
                                    <td bgcolor="#FFCCFF" class="style35">&nbsp;</td>
                                    <td height="22" bgcolor="#FFCCFF" class="style35"><table width="73" border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                          <td width="73" bgcolor="#66FFFF"><div align="center"><span class="style55">Jawapan</span></div></td>
                                        </tr>
                                      </table></td>
                                  </tr>
                                  <tr>
                                    <td bgcolor="#FFCCFF">&nbsp;</td>
                                    <td height="38" bgcolor="#FFCCFF"><? echo $row['answer']; ?>
                                      <hr /></td>
                                  </tr>
                                  <tr>
                                    <td bgcolor="#FFCCFF">&nbsp;</td>
