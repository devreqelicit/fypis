...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','998','height','151','src','banner/banner','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','banner/banner' ); //end AC code
        ...
        <tr>
          <td width="998" height="251" bgcolor="#FFFFFF"><div align="center">
            <?php include("footer/menupenyelia2.php"); ?><table width="693" height="78" border="2" cellpadding="0" cellspacing="0" bordercolor="#333333">
              <tr>
                <td width="749" height="74"><table width="243" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="style34">&nbsp;</td>
                    ...
                    <table width="649" border="0" cellpadding="0" cellspacing="0">
                      <tr>
                        <td width="649"><div align="center">
                            <table width="649" border="2"  bordercolor="#990000" bgcolor="#CC9966" cellpadding="0" cellspacing="0">
                              <tr>
                                <td width="643" bgcolor="#FFCCCC"><div align="center"><br>
                                    <table width="643" height="44" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td width="53">&nbsp;</td>
                                        <td width="516" height="44"><span class="style68"><span class="style68"><? echo $rows['namaSistem']; ?></span></span></td>
                                      </table>
                                    <br>
                                  <table width="529" border="0" cellpadding="0" cellspacing="0">
                                      <tr>
                                        <td class="style45">&nbsp;</td>
                                        <td height="27" class="style45"><span class="style62">Nama</span></td>
                                        <td class="style45"><div align="center" class="style62">:</div></td>
                                        <td><? echo $rows['nama']; ?>&nbsp;</td>
                                      </tr>
                                      <tr>
                                        <td class="style45">&nbsp;</td>
                                        <td height="23" class="style45"><span class="style62">Matrik</span></td>
                                        <td class="style45"><div align="center" class="style62">:</div></td>
                                        <td><? echo $rows['matrik']; ?></td>
                                      </tr>
                                      <tr>
                                        <td class="style45">&nbsp;</td>
                                        <td height="23" class="style45"><span class="style62">Pemeriksa</span></td>
                                        <td class="style45"><div align="center" class="style62">:</div></td>
                                        <td><? echo $rows['pemeriksa']; ?></td>
                                      </tr>
                                      <tr>
                                        <td class="style45">&nbsp;</td>
                                        <td height="22" class="style45"><span class="style62">Penyelia</span></td>
                                        <td class="style45"><div align="center" class="style62">:</div></td>
                                        <td><? echo $rows['penyelia']; ?></td>
                                      </tr>
                                      <tr>
                                        <td>&nbsp;</td>
                                        <td height="25"><span class="style62">Penerangan</span>
                                        ...
                                        <td><div align="center" class="style62">:</div>
