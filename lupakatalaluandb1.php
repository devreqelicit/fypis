...
if (!stristr($emel,"@") OR !stristr($emel,".")) {
$msg="Your emel address is not correct<BR>";
$status= "NOTOK";}
...
//$em=$row->emel;// email is stored to a variable
...
// headers here
/*$headers4="nurfarhana@live.com"; // Change this address within quotes to your address
