          ...
          <tr>
            <td width="998" height="235" bgcolor="#FFFFFF"><div align="center">
              ...
              <table width="998" border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="163" height="217">&nbsp;</td>
                  <td width="667"><table width="637" height="217" border="2" cellpadding="0" cellspacing="0" bordercolor="#333333">
                    <tr>
                                    ...
                                    <tr>
                                      <form action="uploadSuccessfull.php" method="post" enctype="multipart/form-data" name="form1" id="form1" onSubmit="return validateForm()">
                                        <td width="438"><table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                                            ...
                                            <tr>
                                              <td  bgcolor="#FFCCFF"><span class="style26 style51 style26"><strong>&nbsp;Muat Naik Fail (Had Saiz Fail  100 MB)</strong></span></td>
                                            </tr>
                                            <tr>
                                              <td  bgcolor="#FFCCFF">&nbsp;</td>
                                            </tr>
