        ...
        <tr>
          <td width="1001" height="313" bgcolor="#FFFFFF"><table width="1001" height="23" border="0" cellpadding="0" cellspacing="0">
            <tr>
              ...
              <table width="570" height="253" border="2" cellpadding="0" cellspacing="0" bordercolor="#333333">
                <tr>
                  <td width="564" height="249"><table width="216" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                  ...
                  <table width="539" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="517"><div align="center">
                        <table width="514" border="2" cellpadding="0" cellspacing="0" bordercolor="#990000" bgcolor="#cc9999">
                          <tr>
                            <td width="508" height="176" bgcolor="#FFCCCC"><div align="center"><form name="form1" method="post" action="ubahKatalaluanPenyeliadb.php" onSubmit="return validateForm()">
                              <table width="377" height="120" border="0" align="center" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td height="15">&nbsp;</td>
        <td>&nbsp;</td>
        <td>&nbsp;</td>
                                ...
                                <tr>
                                  ...
                                  <td width="212"><input name="katalaluan" type="password" id="katalaluan" size="10" maxlength="10"></td>
      </tr>
                                <tr>
                              ...
                              <table width="244" border="0" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td width="234"><div align="center">
                                    ...
                                    <a href="maklumatPeribadiPenyelia.php">
