...
<body>
<div align="center"><br>
  <table width="1007" height="571" border="2" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
    <tr>
      <td width="1001" height="567" bgcolor="#FFFFFF"><table width="998" height="564" border="0" cellpadding="0" cellspacing="0">
        <tr>
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','998','height','151','src','banner/banner','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','banner/banner' ); //end AC code
        ...
        <tr>
          <td width="998" height="340" bgcolor="#FFFFFF"><div align="center">
            <?php include("footer/menupenyelia.php"); ?><table width="783" height="78" border="2" cellpadding="0" cellspacing="0" bordercolor="#333333">
              <tr>
                <td width="777" height="74"><table width="239" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td class="style34">&nbsp;</td>
                  ...
                  <tr>
                    ...
                    <td width="201" class="style34">&nbsp;<span class="style35">.: Tambah Maklumat Projek :.</span></td>
                  </tr>
                </table>
      ...
      <td width="668" height="173" bgcolor="#CC9999"><div align="center" >
        <table width="281" border="0" cellpadding="0" cellspacing="0">
          ...
          <tr>
            ...
            <td bgcolor="#FF0000">&nbsp;&nbsp;<span class="style43">MAKLUMAT PROJEK TELAH DIREKODKAN !!! </span></td>
          </tr>
          <tr>
