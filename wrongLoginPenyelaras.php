      ...
      <td width="1000" height="466" bgcolor="#FFFFFF"><table width="1000" height="464" border="0" cellpadding="0" cellspacing="0">
		  ...
		  <tr>
			<td width="436"><div align="center">
			  <table width="460" border="0" cellpadding="0" cellspacing="0">
				...
				<tr>
				  <td width="14"><div align="center"><img src="menu/error2.png" alt="" width="51" height="38" /></div></td>
				  <td width="324"><span class="style35">&nbsp;<span class="style31"><font color="red"><strong>Invalid StaffID / Password!</strong></font></span></span></td>
				</tr>
			  </table>
			</div></td>
			</tr>
          <tr>
            <td height="229" bgcolor="#FFFFFF"><table width="1000" height="243" border="0" cellpadding="0" cellspacing="0" bordercolor="#FFFFFF">
              <tr>
                <td width="160" height="243" bgcolor="#FFFFFF">&nbsp;</td>
                <td width="412" bgcolor="#FFFFFF"><table width="412" height="290" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td height="21">
						<div id="mainmenu">
							<div class="mainmenu">
                    ...
                    <tr>
                      <td height="202"><div align="left"></div>
                          <form id="form1" name="form1" method="post" action="checkLoginPenyelaras.php">
                                ...
                                <td width="426" height="155"><div align="left">
                                  <table width="284" height="26" border="0" cellpadding="0" cellspacing="0">
                                    <tr>
                                      ...
                                      <td width="276"><span class="style18">LOGIN : COORDINATOR</span></td>
                                    </tr>
                                  </table>
                                  <div align="center">
